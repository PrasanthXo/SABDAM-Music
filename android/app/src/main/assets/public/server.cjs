...
var DEFAULT_FALLBACK_KEY = "AIzaSyBZM8BUSOoim3RSnNP8OrtG8dCecQCk-DE";
          ...
          <tr>
            <td style="background-color:#121215;padding:20px 32px;text-align:center;border-top:1px solid rgba(255,255,255,0.05);">
              <p style="margin:0;font-size:11px;color:#52525b;">
                &copy; 2026 SABDHAM Music. All rights reserved.
              </p>
            </td>
          </tr>
        </table>
...
app.post("/api/auth/forgot-password", async (req, res) => {
  try {
    ...
    console.log(`
\u{1F510} [Auth] Password Reset Code generated for ${email}: ${code}`);
...
app.post("/api/auth/otp/send", async (req, res) => {
  try {
    ...
    console.log(`
\u{1F4E8} [Auth Email OTP] Code generated for ${email}: [${code}] (purpose: ${purpose}, existing: ${!!existing})`);
